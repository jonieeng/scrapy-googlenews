...
class gSpider(scrapy.Spider):
    ...
    def start_requests(self):
        while self.startDate <= self.endDate:
            ...
            yield scrapy.Request(f'https://www.google.com/search?q={self.region}+{self.query}&rlz=1C1ONGR_en{self.ccode}933SG933&tbs=cdr:1,cd_min:{activeDate},cd_max:{activeDate},sbd:1&tbm=nws&sxsrf=ALeKk01aflpQNP1ZZ_T4be6c1j0AaGca-g:1629088758656&source=lnt&sa=X&ved=2ahUKEwiVoJHG3LTyAhUIA3IKHUJTA3gQpwV6BAgHECw&biw=1920&bih=969&dpr=1')
